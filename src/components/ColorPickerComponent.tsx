...
export default function ColorPickerComponent({ onColorChange }: ColorPickerComponentProps) {
  ...
  return (
    <section className="w-full bg-white pt-3">
      <div className="flex items-center gap-4">
            ...
            {RUBIK_COLORS.map((color) => {
              ...
              return (
                <button
                  ...
                  className={`h-8 w-8 rounded-md border transition-transform hover:scale-105 ${isSelected ? 'border-gray-900 ring-2 ring-gray-400' : 'border-gray-300'}`}
        ...
        <div className="flex items-center gap-3">
          ...
          <div
            className={`flex h-8 w-8 items-center justify-center rounded-md border border-gray-300 px-2 text-sm font-semibold ${selectedTextColor}`}
